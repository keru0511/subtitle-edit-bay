...
- プレビュー上部のアクションバーを高さ36pxの1行インラインバーへスリム化し、上下マージンを調整してプレビュー表示域を拡大。
- アプリ全体の配色をmockのTailwindダークパレット（#0B0F17, #131A26, #1A2332, #243044）に統一し、素材カードの階層感とコントラストを強化。
...
| 寸法・スタイル | 基本配色（#0B0F17系ダークパレット）・プレビュー上部スリムバー化・素材カード階層を反映済み。詳細モーダルやボタン寸法の全面一致は継続対応 |
