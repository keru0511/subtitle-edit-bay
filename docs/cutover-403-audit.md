...
| 通常動画のmedia bin・mode rail・SequenceEditorPanelがproduction導線にある | src/ui/components/WorkspaceHeader.qml、EditorModeRail.qml、SequenceEditorPanel.qml、src/ui/screens/MainWorkflowScreen.qml | tests/test_production_integration.py::ProductionIntegrationContractTests.test_production_workflow_routes_all_cross_workspace_actions_to_backend、tests/test_qml_static.py::test_sequence_editor_uses_backend_view_and_mutation_boundary | CI / qt-gui、Windows runtime tests のStart GUI on Windows |
