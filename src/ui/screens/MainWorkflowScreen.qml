        ...
        Item {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    Layout.fillWidth: true
                    spacing: 5
                    SmallButton { objectName: "workspaceSubtitleUndoButton"; text: "元に戻す"; enabled: root.appBackend.subtitles.canUndo; onClicked: root.appBackend.subtitles.undoSubtitleEdit() }
                    SmallButton { objectName: "workspaceSubtitleRedoButton"; text: "やり直す"; enabled: root.appBackend.subtitles.canRedo; onClicked: root.appBackend.subtitles.redoSubtitleEdit() }
                    SmallButton {
                    ...
                    SmallButton { objectName: "workspaceSubtitleDeleteButton"; text: "削除"; enabled: !root.appBackend.running && root.appBackend.subtitles.selectedSegmentIndex >= 0; onClicked: root.appBackend.subtitles.deleteSelectedSegment() }
                    ...
                    SmallButton { objectName: "workspaceSubtitlePreviewButton"; text: "プレビュー更新"; enabled: !root.appBackend.running; onClicked: root.appBackend.subtitles.buildSubtitlePreview(root.currentSettings()) }
                }
    ...
    Rectangle {
        ...
        Component {
            ...
            RowLayout {
                ...
                SmallButton { objectName: "undoCaptionButton"; text: "元に戻す"; enabled: root.appBackend.subtitles.canUndo; onClicked: root.appBackend.subtitles.undoSubtitleEdit() }
                SmallButton { objectName: "redoCaptionButton"; text: "やり直す"; enabled: root.appBackend.subtitles.canRedo; onClicked: root.appBackend.subtitles.redoSubtitleEdit() }
                SmallButton { objectName: "addCaptionButton"; text: "+ 字幕追加"; onClicked: root.appBackend.subtitles.addSegment(mainPlayer.position / 1000) }
                SmallButton { objectName: "splitCaptionButton"; text: "分割"; enabled: root.canSplitSelectedSegment(mainPlayer.position); onClicked: root.appBackend.subtitles.splitSelectedSegment(mainPlayer.position / 1000) }
                SmallButton { objectName: "deleteCaptionButton"; text: "削除"; enabled: root.appBackend.subtitles.selectedSegmentIndex >= 0; onClicked: root.appBackend.subtitles.deleteSelectedSegment() }
                SmallButton { objectName: "saveProjectButton"; text: "保存"; onClicked: root.appBackend.saveProject() }
                SmallButton { objectName: "buildAssButton"; text: "プレビューを更新"; onClicked: root.appBackend.subtitles.buildSubtitlePreview(root.currentSettings()) }
                Button {
                ...
                Rectangle {
                    ...
                    ColumnLayout { anchors.fill: parent; anchors.margins: 8; spacing: 7
                        ...
                        ListView {
                            ...
                            onCurrentIndexChanged: if (currentIndex >= 0) root.appBackend.subtitles.selectSegment(currentIndex)
                            delegate: Rectangle {
                                id: captionRow
                                required property int index
                                        ...
                                        onActiveFocusChanged: {
                                            if (activeFocus) {
                                                ...
                                                if (editedText !== captionRow.editorText)
                                                    root.appBackend.subtitles.updateSegment(captionRow.index, {"text": editedText})
