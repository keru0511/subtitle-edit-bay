...
class ContextActionBarQmlTests(unittest.TestCase):
    ...
    def test_action_bar_preserves_all_workflow_actions_and_states(self) -> None:
        ...
        self.assertIn("implicitHeight: 148", action_bar)
        self.assertIn("columns: 3", action_bar)
    ...
    def test_detail_settings_are_popup_based_and_keep_standard_sizes(self) -> None:
        ...
        self.assertIn('objectName: "advancedSettingsScrollView"', workflow)
        self.assertIn('objectName: "advancedSettingsContent"', workflow)
        self.assertIn('objectName: "advancedSettingsVerticalScrollBar"', workflow)
        self.assertIn('objectName: "settingsPopupSaveButton"', workflow)
        self.assertIn('objectName: "settingsPopupCloseButton"', workflow)
        self.assertIn("contentHeight: advancedSettingsContent.implicitHeight", workflow)
        self.assertIn("ScrollBar.horizontal.policy: ScrollBar.AlwaysOff", workflow)
        self.assertIn("policy: ScrollBar.AlwaysOn", workflow)
